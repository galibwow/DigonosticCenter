<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DateWiseTestsReport.aspx.cs" Inherits="DisgonisticCenter.UI.DateWiseTestsReport" %>
<!DOCTYPE html>
...
<head>
  ...
  <div class="row">
    ...
    <div>
        ...
        <table class="auto-style1">
            <tr>
                ...
                <td>
                    ...
                    <input type="date" id="startDateTimepicker" class="form-control" runat="server"/>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <input type="date" id="endDateTimePicker" class="form-control" runat="server" />
        ...
        <asp:GridView ID="TestsGridView" runat="server" AutoGenerateColumns="False" Width="634px" CssClass="table table-hover table-bordered" OnRowDataBound="TestsGridView_RowDataBound" ShowFooter="True">
        ...
        <asp:Button ID="pdfButton" runat="server" CssClass="btn btn-info" OnClick="pdfButton_Click" Text="Pdf" />
    </form>
