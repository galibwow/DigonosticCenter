<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="DisgonisticCenter.UI.Payment" %>
<!DOCTYPE html>
<html lang="en">
<head runat="server">
                        ...
                        <ul class="nav navbar-nav">
                            <li id="userMenu" class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li> <a href="DateWiseTestTypeReport.aspxx">Test Type Report</a> </li>
  ...
  <div class="row">
    ...
    <div>
        ...
        BillNo</div>
        <asp:TextBox ID="billNoTextBox" runat="server" CssClass="form-control"></asp:TextBox>
        <asp:Button ID="searchButton" runat="server" Text="Search" CssClass="btn btn-success" OnClick="searchButton_Click" />
        <br />
        <asp:GridView ID="paymentGridView" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="750px">
        ...
        <table class="auto-style1">
            <tr>
                ...
                <td>
                    <asp:Label ID="billdateLabel" runat="server" Text="Bill Amount"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="paidAmount" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
        ...
        Amount<asp:TextBox ID="amountTextBox" CssClass="form-control" runat="server"></asp:TextBox>
