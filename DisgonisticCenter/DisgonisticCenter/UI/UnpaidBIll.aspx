<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnpaidBIll.aspx.cs" Inherits="DisgonisticCenter.UI.UnpaidBIll" %>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <h2 class="text-center">Unpaid Bill Report</h2>
  <div class="row">
    ...
    <div>
       <table class="auto-style1" style="align-content: center">
            ...
            <tr>
                <td>To date</td>
                <td>
                    <input type="date" id="endDateTimePicker" runat="server"/>
        ...
        <asp:GridView ID="unpaidGridView" runat="server" AutoGenerateColumns="False" OnRowDataBound="unpaidGridView_RowDataBound" CellPadding="4" GridLines="Horizontal" ShowFooter="True" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" Width="634px">
            <Columns>
                ...
                <asp:BoundField DataField="NameOfThePatient" HeaderText="Paitent Name" />
                <asp:BoundField DataField="PaymentStatus" HeaderText="Bill Amount" />
            </Columns>
        ...
        <asp:Button ID="pdfButton" CssClass="btn btn-info" runat="server" OnClick="pdfButton_Click" Text="Pdf" />
